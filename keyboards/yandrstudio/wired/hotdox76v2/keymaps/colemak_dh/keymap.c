...
const uint16_t PROGMEM qwerty_toggle_combo[] = {LSFT_T(KC_N), LCTL_T(KC_E), LALT_T(KC_I), LGUI_T(KC_O), COMBO_END};
 ...
 */
	LAYOUT(
       ...
       KC_NO, QK_RBT,   KC_NO,    KC_NO,    KC_NO,    KC_NO, KC_NO,
 ...
 */
	LAYOUT(
       ...
       KC_LCAP, KC_A, KC_S, KC_D, KC_F, KC_TRNS,
